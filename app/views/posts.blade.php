              ...
              <div class="inner-content">
                ...
                <div class="hoverlay"> 
                  ...
                  <div class="post-text-wrap-container">
                    <div class="post-text-wrap">
                      <div class="post-meta">
                        ...
                        <p class="excerpt">{{substr($post['content'], 0, 145)}}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="post-text-bottom">
                    <div><a href="/posts/{{$post['postid']}}/edit" class="readmore">Edit<i class="icon-arrow-right8"></i></a> <a href="/posts/{{$post['postid']}}" class="readmore">Read More<i class="icon-arrow-right8"></i></a><a href="/posts/{{$post['postid']}}" class="comments-info"><i class="icon-blandes-bubble"></i>{{count($post['comments'])}}</a></div>
                  </div>
                </div>
                </div>
                </div> 
