...
<head>
    ...
    <link rel="stylesheet" href="http://{{$_SERVER['HTTP_HOST']}}/plugins/bootstrap/css/bootstrap.min.css" />
    </script>
</head>

<body class="responsive">
    <div id="loading" class="loaderDiv" ><img src="http://{{$_SERVER['HTTP_HOST']}}/images/loader.gif" style="margin-top:20%;"/><p>Loading please wait...</p></div>
                            ...
                            <div class="span12">
                                ...
                                <div class="logo-container">
                                    ...
                                    <a href="#" id="logo" class="clearfix">
                                        <img src="http://{{$_SERVER['HTTP_HOST']}}/images/logo.png" alt="JSOBlog" />
                                    </a>
                                ...
                                <ul id="main_menu" class="main_menu">
                                    ...
                                    <li id="menu-item-2614" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-2614">
                                        <a href="/create">
                       New Post
                      </a>
                                    </li>
...
<!-- Javascript Files --> 
    ...
    <script type="text/javascript" src="http://{{$_SERVER['HTTP_HOST']}}/plugins/jquery.form.js"></script>
    </script>
    <script src="http://{{$_SERVER['HTTP_HOST']}}/plugins/ckeditor/ckeditor.js">
